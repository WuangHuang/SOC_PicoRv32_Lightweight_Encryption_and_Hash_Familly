...
## ============================================
## Clock — 100 MHz board oscillator at E3, used
## DIRECTLY as the system clock (no /2 divider).
## All logic is timed against clk_100 @ 10 ns.
## ============================================
...
## ============================================
## Note: the system now runs directly at 100 MHz
## (10 ns). After implementation, check clk_100
## WNS >= 0 in report_timing_summary. If it fails
## (ChaCha carry chain was ~15.5 ns in the 50 MHz
## build), fall back to the /2 divider in system.v
## + UART DEFAULT_DIV 434 + create_generated_clock:
##   create_generated_clock -name clk_sys \
##     -source [get_pins bufg_in/O] -divide_by 2 \
##     [get_pins bufg_sys/O]
## ============================================